...
function test() {
  ...
  console.assert(
    assessment('太郎') === assessment('太郎'), '同じ名前で同じ結果になっていません'
  );
  console.assert(
    assessment('次郎') === assessment('次郎'), '同じ名前で同じ結果になっていません'
  );
  console.assert(
    assessment('花子') === assessment('花子'), '同じ名前で同じ結果になっていません'
  );
